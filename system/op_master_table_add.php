                ...
                <div class="card">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-2 bg-warning p-2 text-white" id='static_list_area'>
                                ...
                                <?php echo dropdown_list('op_config','id','option_name',$input_arr[0]??null, array('option_type'=>'LIST')); ?>
                                </select>
                        </div>
                        ...
                        <div class='bg-success p-2 mb-2 text-white' id='dynamic_list_area' >
                            <div class="form-group mb-4">
                                ...
                                <?php echo dropdown($table_list['data'], $input_arr[0]??null); ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <?php echo dropdown_list('op_master_table','column_name','column_name',array_filter([$inputvalue[1] ?? null]),array('table_name'=>$input_arr[0])); ?>
